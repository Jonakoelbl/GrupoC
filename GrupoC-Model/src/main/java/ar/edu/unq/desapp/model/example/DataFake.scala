...
object DataFake extends Builder {
  /* Generate users */
  val userA: User = anUser.withName("Jona").withEmail("jona@mail.com").withPassword("jona").build
  val userB: User = anUser.withName("beto").withEmail("beto@email.com").withPassword("beto").build
  val userC: User = anUser.withName("Ursu").withEmail("ursu@email.com").withPassword("ursu").build
  val userD: User = anUser.withName("carlo").withEmail("carlo@email.com").withPassword("carlo").build
  val userE: User = anUser.withName("mati").withEmail("mati@email.com").withPassword("mati").build
